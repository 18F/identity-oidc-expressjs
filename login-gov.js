...
const discoveryUrl = 'http://localhost:3000' // 'https://idp.int.login.gov/'
...
loginGov.configure = function(passport, loaNumber){
  ...
  Promise.all([
    ...
    const strategy = new Strategy({client: client, params: strategyParams(loaNumber)}, function(tokenset, userinfo, done) {
